...
> Basically, At compile time, compiler asks -- do i have this method in my reference (left hand side) type ? -- If yes, I am fine, I wont complain
> But at the runtime, i will call the actual (Right hand side) object's method.
